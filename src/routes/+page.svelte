    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
      <div class="text-center">
        ...
        <p class="mt-6 text-lg leading-8 text-gray-600">
          ...
          streamline projects, simplify quoting, automate billing, and optimize
          utilization.
        </p>
      ...
      >
        <div class="relative pl-16">
          ...
          <dd class="mt-2 text-base leading-7 text-gray-600">
            Track everything from projects, sales, taxes, and profitability
          </dd>
        </div>
        ...
        <div class="relative pl-16">
          ...
          <dd class="mt-2 text-base leading-7 text-gray-600">
            ...
            off the work and expenses generating instant invoices and fast
            payments.
          </dd>
        </div>
      </dl>
