    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
      <div class="text-center">
        <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
          ALL your business administration in one place
        </h1>
    ...
    >
      ...
      >
        ...
        <div class="relative pl-16">
          ...
          <dd class="mt-2 text-base leading-7 text-gray-600">
            Accelerate decision making with production companies, talent
            agencies and actors. Seamless flow of information, messaging and
        ...
        <div class="relative pl-16">
          ...
          <dd class="mt-2 text-base leading-7 text-gray-600">
            As actors complete their work schedule, clients can immediately sign
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    ...
    >
      <div class="-mt-8 sm:-mx-4 sm:columns-2 sm:text-[0] lg:columns-3">
        <Testimonial
          main="“Keeping track of our client's invoices and payments has never been easier”"
          secondary="Every invoice we issue gives rise to lots of payments - I now track my data in one place and am in control"
          imageSource="/rob_comeau.jpg"
          name="Rob Comeau, Film Producer"
        />

        <Testimonial
          main="“Finally, an application that works”"
          ...
          name="Teri Ritter, Talent Agent"
        />

        <Testimonial
          main="“It’s simple, highly professional and saves me so much time”"
          secondary="I handle everything from my mobile and no longer need to use complicated tools just to issue invoices and track payments"
